...
import {LoaderCircleIcon, Trash2Icon} from "@horionos/icons";
  ...
  return (
    <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
      <div className="space-y-2">
        <Text className="text-lg font-semibold">Invite a teammate</Text>
              ...
              {(field) => (
                <div className="grid gap-3">
                  ...
                  <Select
                    ...
                    value={field.state.value}
                    onValueChange={(value) =>
                      field.handleChange(value as MembershipRole)
                    }
                  >
                    <SelectTrigger>
...
const InvitationsListSection = () => {
  ...
  return (
    <section className="grid gap-x-8 gap-y-6">
      <div className="space-y-2">
        <Text className="text-lg font-semibold">Invitations</Text>
        <Text className="max-w-sm">
...
const InvitationRoleBadge = ({role}: {role: MembershipRole}) => {
  if (role === "admin") {
