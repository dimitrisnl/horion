...
export const invitationsStatusEnum = pgEnum("invitations_status", [
  "pending",
  "accepted",
  "declined",
]); // expired is inferred from expiresAt
...
export const invitations = pgTable(
  "invitations",
  {
    ...
    status: invitationsStatusEnum("status").default("pending").notNull(),
    expiresAt: timestamp("expires_at").notNull(),
